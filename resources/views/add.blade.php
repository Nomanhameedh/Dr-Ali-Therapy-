...
<div class="max-w-2xl mx-auto my-16 p-8 bg-white rounded shadow">
    ...
    <h2 class="text-3xl font-bold mb-6 text-center">ADD</h2>
    ...
    <form method="POST" action="{{ route('article.save') }}" class="space-y-4">
        @csrf
        ...
        <div>
         ...
         <div>
            <label class="block mb-1 font-semibold">Discreption</label>
            <input type="text" name="user_name" required
...
{{-- 
        <div>
            ...
            <select name="therapy_package_id" required
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
