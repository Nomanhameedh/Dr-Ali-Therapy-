...
<section class="bg-blue-600 text-white py-20 text-center">
    <h1 class="text-4xl font-bold mb-4">Ali Therapy – Mental & Physical Wellness Made Simple</h1>
    <p class="mb-6 text-lg">Professional therapy. Online & on-site. One platform.</p>
